...
impl From<super::Trying> for Proceeding {
    fn from(from: super::Trying) -> Self {
        Self {
            entered_at: Instant::now(),
            retransmissions_count: from.retransmissions_count,
            last_retransmission_at: from.last_retransmission_at,
        }
    }
}
